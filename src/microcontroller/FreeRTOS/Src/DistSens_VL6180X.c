...
void measureDistanceValue(void){
	do{
		dataBuffer[0] = 0;
		if(HAL_I2C_Mem_Read(&hi2c1, VL6180X_DevAddress,0x004F,2, dataBuffer, 1, 100)==HAL_OK);
	...
	dataBuffer[0] = 0;
	if(HAL_I2C_Mem_Read(&hi2c1, VL6180X_DevAddress,0x0062,2, dataBuffer, 1, 100)==HAL_OK);
	distanceValue = dataBuffer[0];

	//Clear interrupt status flag
	dataBuffer[0] = 0x07;
	if(HAL_I2C_Mem_Write(&hi2c1, VL6180X_DevAddress, 0x0015,2, dataBuffer, 1, 100)==HAL_OK);
